 ...
 * @author Raj Bagaria
 * @notice This contract is for creating untamperable decentraliZzd smart contract
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /***
     * @dev - This is the function that the chainlink keeper nodes calll
    ...
    function checkUpkeep(
        ...
        // Check if the time is right to pick a winner
        // If so, call requestRandomWinner
